...
CHAT_PP_CHANGED = "`Foto Group Telah di Ganti..`"
CHAT_PP_ERROR = (
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"setgpic$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"promote(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"demote(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"ban(?: |$)(.*)"))
async def ban(bon):
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"unban(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(incoming=True))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"ungmute(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"gmute(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"zombies(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"admins$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"pin(?: |$)(.*)"))
async def pin(msg):
    # Admin or creator check
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"kick(?: |$)(.*)"))
async def kick(usr):
    # Admin or creator check
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"users ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"usersdel ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"bots$"))
...
CMD_HELP.update(
    {
        "admin": f">`{geez}promote <username/reply> <custom rank (optional)>`"
        "\nUsage: Provides admin rights to the person in the chat."
        f"\n\n>`{geez}demote <username/reply>`"
        "\nUsage: Revokes the person's admin permissions in the chat."
        f"\n\n>`{geez}ban <username/reply> <reason (optional)>`"
        "\nUsage: Bans the person off your chat."
        f"\n\n>`{geez}unban <username/reply>`"
        "\nUsage: Removes the ban from the person in the chat."
        f"\n\n>`{geez}mute <username/reply> <reason (optional)>`"
        "\nUsage: Mutes the person in the chat, works on admins too."
        f"\n\n>`{geez}unmute <username/reply>`"
        "\nUsage: Removes the person from the muted list."
        f"\n\n>`{geez}gmute <username/reply> <reason (optional)>`"
        "\nUsage: Mutes the person in all groups you have in common with them."
        f"\n\n>`{geez}ungmute <username/reply>`"
        ...
        f"\n\n>`{geez}users` or >`{geez}users <name of member>`"
        "\nUsage: Retrieves all (or queried) users in the chat."
        f"\n\n>`{geez}setgpic <reply to image>`"
